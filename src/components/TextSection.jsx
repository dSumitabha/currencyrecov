    ...
    return (
        <section className="relative py-32">
            ...
            <div className="relative z-10 mx-auto max-w-6xl px-6 py-20 text-center">
                <span className="pointer-events-none absolute left-1/2 top-0 h-px w-[110%] -translate-x-1/2 bg-gradient-to-r from-transparent via-cyber-black/40 to-transparent dark:via-white/60" />
                <span className="pointer-events-none absolute left-1/2 bottom-0 h-px w-[110%] -translate-x-1/2 bg-gradient-to-r from-transparent via-cyber-black/40 to-transparent dark:via-white/60" />
                <span className="pointer-events-none absolute top-1/2 left-0 w-px h-[110%] -translate-y-1/2 bg-gradient-to-b from-transparent via-cyber-black/40 to-transparent dark:via-white/60" />
                <span className="pointer-events-none absolute top-1/2 right-0 w-px h-[110%] -translate-y-1/2 bg-gradient-to-b from-transparent via-cyber-black/40 to-transparent dark:via-white/60" />
